        ...
        <div class="main">
            ...
            <div class="section-2 bg-[#FAFAFA] pl-3 md:flex sm:pl-10 lg:pl-59 pb-27 pt-30 relative">
                <div class="left sm:w-[45%] w-full">
                    ...
                    <div class="mt-7 text-start wrap-break-word content font-[poppins] text-sm text-[#8A8A8A]">Lorem
                        ipsum dolor sit
                        ...
                        <div class="clock flex space-x-5">
                            <div class="days">
                                <div
                                    ...
                                    <div
                                        class="num text-4xl leading-[100%] tracking-[0%] text-[#484848] font-[Digital-Numbers]">
                                        02</div>
                                </div>

                                <div
                                    class="mt-3 font-[Poppins] text-xl leading-[120%] tracking-[0%] text-center text-[#484848]">
                                    Days</div>
                            </div>
                            <div class="hr ">
                                <div
                ...
                <div class="right flex space-x-5 pl-2 pt-3 sm:pt-0 sm:pl-24">
                    <div class="image-1 relative">
                        ...
                        <div
                            class="card absolute lg:flex hidden w-45 h-28  bg-white backdrop-blur-[7px] left-7 bottom-5 flex-col">
            ...
            <div class="section-3 mt-28 md:px-10 px-2 lg:px-59">
                <div
                    ...
                    New Arrivals</div>
                <div
                    class="sub-heading text-[#8A8A8A] mt-5 text-sm font-[poopins leading-[20px] tracking-[0%] text-center]">
                ...
                <div class="buttons flex gap-4 justify-between mt-10">
                    ...
                    <button class="px-8 p-3 rounded-lg cursor-pointer bg-black text-white font-poppins text-sm">Women’s
                        Fashion</button>
                    <button
                        class="px-8 p-3 rounded-lg cursor-pointer bg-[#fafafa] text-[#8A8A8A] font-poppins text-sm">Women
                        Accessories</button>
                    <button
                        class="px-8 p-3 rounded-lg cursor-pointer bg-[#fafafa] text-[#8A8A8A] font-poppins text-sm">Men
                        Accessories</button>
                ...
                <div class="hero-section flex justify-center flex-wrap gap-10">
                    <div
                        class="card-1 w-74 h-auto justify-center p-5 rounded-[10px] bg-white shadow-[0px_40px_90px_0px_#0000000F]">
                        <img src="../assets/home/section-3/Images-1.png" />
                        <div class="top-items flex justify-between pt-3">
                            <div
                                class="font-[Poppins] font-medium text-base leading-[100%] tracking-[0%] text-[#484848]">
                                Shiny Dress</div>
                        ...
                        <div
                            ...
                            (4.1k) Customer Reviews</div>
                        <div class="bottom-text flex justify-between pt-5">
                            <div
                                class="font-[Poppins] font-medium text-base leading-[20px] tracking-[-1%] text-[#484848]">
                                $95.50</div>
                    ...
                    <div
                        class="card-2 w-74 h-auto justify-center p-5 rounded-[10px] bg-white shadow-[0px_40px_90px_0px_#0000000F]">
                    ...
                    <div
                        class="card-3 w-74 h-auto justify-center p-5 rounded-[10px] bg-white shadow-[0px_40px_90px_0px_#0000000F]">
                    ...
                    <div
                        class="card-4 w-74 h-auto justify-center p-5 rounded-[10px] bg-white shadow-[0px_40px_90px_0px_#0000000F]">
                    ...
                    <div
                        class="card-5 w-74 h-auto justify-center p-5 rounded-[10px] bg-white shadow-[0px_40px_90px_0px_#0000000F]">
                    ...
                    <div
                        class="card-6 w-74 h-auto justify-center p-5 rounded-[10px] bg-white shadow-[0px_40px_90px_0px_#0000000F]">
                ...
                <div class="button">
                    <button
                        class="px-13 p-3 mt-9 shadow-lg cursor-pointer text-sm rounded-lg bg-[#000000] text-white">View
                        More</button>
                </div>
            ...
            <div class="section-6 bg-[#fafafa] pt-20 pb-13">
                ...
                <div
                    class="sub-heading font-[Poppins] mt-3 text-sm leading-[26px] tracking-[0] text-center text-[#8A8A8A]">
                ...
                <div class="cards relative flex items-center justify-center mt-12">
                    ...
                    <div
                        class="card-1 flex-shrink-0 left-90 relative scale-70 w-auto sm:w-166 pt-17 pb-11 h-auto flex gap-15 p-9 pr-13  bg-white shadow-[0px_14.95px_44.86px_0px_rgba(46,33,61,0.08)] rounded-lg">
                        <div class="left background bg-[#D9D9D9]">
                            <div class="box relative flex items-center justify-center w-50 h-46 bg-[#D9D9D9] ">
                                <img src="../assets/home/section-6/image-1.png "
                                    class=" w-46 absolute right-0 bottom-4 " />
                            </div>
                        </div>

                        <div class="right text-start">
                            <div class="content text-sm text-[#484848]">“Items That I ordered were the best investment I
                                ever made. I can't say enough about your quality service."</div>
                            ...
                            <div
                                class="content mt-4 text-2xl leading-[100%] tracking-[0%] font-[Volkhov] text-[#484848]">
                                Suzan B.</div>
                            <div
                                class="traveler mt-4 text-sm leading-[100%] tracking-[0%] font-[Poppins] text-[#484848]">
                                UI Designer</div>
                        </div>
                    </div>

                    <div
                        class="card-2 flex-shrink-0 relative z-10 w-166 pt-17 pb-11 h-auto flex gap-15 p-9 pr-13  bg-white shadow-[0px_14.95px_44.86px_0px_rgba(46,33,61,0.08)] rounded-lg">
                        <div class="left background bg-[#D9D9D9]">
                            <div class="box relative w-50 h-46 bg-[#D9D9D9] ">
                                <img src="../assets/home/section-6/image-2.png "
                                    class=" w-46 absolute right-0 bottom-4 " />
                            </div>
                        </div>

                        <div class="right text-start">
                            <div class="content text-sm text-[#484848]">"You won't regret it. I would like to personally
                                thank you for your outstanding product. Absolutely wonderful!"</div>
                    ...
                    <div
                        class="card-3 right-89 flex-shrink-0 relative scale-70 w-166 pt-17 pb-11 h-auto flex gap-15 p-9 pr-13  bg-white shadow-[0px_14.95px_44.86px_0px_rgba(46,33,61,0.08)] rounded-lg">
                        <div class="left background bg-[#D9D9D9]">
                            <div class="box relative w-50 h-46 bg-[#D9D9D9] ">
                                <img src="../assets/home/section-6/image-3.png "
                                    class=" w-46 absolute right-0 bottom-4 " />
                            </div>
                        </div>

                        <div class="right text-start">
                            <div class="content text-sm text-[#484848]">“Just what I was looking for. Thank you for
                                making it painless, pleasant and most of all hassle free! All products are great.”</div>
