        ...
        <div class="hero flex">
            <div class="left w-[25%]">
                ...
                <div class="colors mt-5">
                    ...
                    <div class="flex gap-2 flex-wrap mt-4">
                        <button v-for="(connectData , i) in allProducts" :key="i" @click="selectedColor = color"
                            :style="{ backgroundColor: connectData.colors   }"
            ...
            <div class="right w-[75%]">
                ...
                <div class="cards flex flex-wrap gap-3.5 gap-y-10 mt-5">
                    ...
                    <div v-for="(product, i) in allProducts" class="card">
                        <div class="img w-58">
                        ...
                        <div class="button mt-3 flex gap-2">
                            <button :style="{ backgroundColor: product.colors }"
...
const { selectedColor } = useFilters()
...
const getUniqueData = (data , pro) => {
    let newVal = data.map((curEle) => {
        return curEle[pro]
    })
     
    newVal = ["All" , ...new Set(newVal)]
    console.log("uniqe Data" , newVal)
}

const categoryOnlyData  = getUniqueData(allProducts.value , "colors")
